    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pengumumen.update", [$pengumuman->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uraian') ? 'is-invalid' : '' }}" type="text" name="uraian" id="uraian" value="{{ old('uraian', $pengumuman->uraian) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('is_arsip') ? 'is-invalid' : '' }}" type="text" name="is_arsip" id="is_arsip" value="{{ old('is_arsip', $pengumuman->is_arsip) }}">
