    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.dasar-hukums.update", [$dasarHukum->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('uraian') ? 'is-invalid' : '' }}" type="text" name="uraian" id="uraian" value="{{ old('uraian', $dasarHukum->uraian) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomor') ? 'is-invalid' : '' }}" type="text" name="nomor" id="nomor" value="{{ old('nomor', $dasarHukum->nomor) }}" required>
                @if($errors->has('nomor'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tahun') ? 'is-invalid' : '' }}" type="text" name="tahun" id="tahun" value="{{ old('tahun', $dasarHukum->tahun) }}" required>
                @if($errors->has('tahun'))
